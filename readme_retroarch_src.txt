This source is the diff from this version: https://github.com/libretro/RetroArch/releases/tag/v1.14.0
...
tasks/task_screenshot.c : Fixed implicit declaration warnings
